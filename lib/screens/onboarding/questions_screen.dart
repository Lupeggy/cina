...
class _QuestionsScreenState extends State<QuestionsScreen> {
  ...
  final List<Map<String, dynamic>> _questions = [
    {
      'question': 'What type of movie locations interest you most?',
      'type': 'single_select',
      'key': 'location_type',
      'options': [
    ...
    {
      'question': 'Which movie genres do you enjoy?',
      'type': 'multi_select',
      'key': 'movie_genres',
      'options': [
        'Action & Adventure',
    ...
    {
      'question': 'How do you prefer to experience film locations?',
      'type': 'single_select',
      'key': 'experience_type',
      'options': [
        'Guided tours',
